...
This model works well with Adam optimizer, lr=1e-4, BCE loss function and ELU or
ReLU activation functions. This has fewer paramters than the Zhou version which
uses Conv2DTranspose instead of UpSampling2D. In theory, this should mean lower
complexity and therefore accuracy, but, results indicate otherwise. Addition of
two Dropout layers with P=0.5 add noise to the network to promote generalisation
and reduced over-fitting to the training data.
"""
